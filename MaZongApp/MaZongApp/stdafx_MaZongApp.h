 ...
 * 注销登录接口
 */
static NSString* URL_ROOT = @"http://115.29.147.177:8099/interface";
...
static NSString* URL_STITIC_ADS = @"http://115.29.147.177:8099/interface/getAdvertiseList";
static NSString* URL_DY_ADS = @"http://115.29.147.177:8099/interface/getAdvertiseList";
